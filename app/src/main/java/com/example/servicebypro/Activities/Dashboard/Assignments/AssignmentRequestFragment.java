...
public class AssignmentRequestFragment extends DialogFragment implements
        android.view.View.OnClickListener, ApplicationAdapter.OnApplicationListener {

    private static final String TAG = "AssignmentRequestFragme";
    LinearLayout expandableView_work_details, expandableView_work_service;
    Button arrowBtn;
    CardView cardView, cardView_client, cardView_payment, cardView_freelancer, cardView_applications, cardView_service, cardView_location;
    private Util util;
    ...
    LinearLayout work_price_layout, payment_method_layout, expandableView_work_applications, expandableView_work_freelancer,
            expandableView_work_location, work_status_by_time_layout, expandableView_work_payment, expandableView_work_client
            ,freelancer_buttons_layout;
    TextView option_digit, work_payment_method, work_freelancer_name, work_status_by_time, work_category, no_applications;
    ImageView freelancer_avatar,client_avatar,work_image1,work_image2,work_image3;
    ...
    private AssignmentRequestFragment.FragmentSelectApplicationForDetails listener;
    public interface FragmentSelectApplicationForDetails {
        void onInputSelectUserApplicationForDetailsSent(Application application);
    }
    ...
    public AssignmentRequestFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_assignment_request, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.accept_button:
               //TODO
                //todo only if due date is not outdated if outdated do nothing
                if (!util.isInternetConnected()) {
                    //Show a dialog
                    util.ShowCustomDialog();
                }else{
                    acceptWorkProposal(work.getApplications().get(0));
                }
                break;
            case R.id.decline_button:
                ...
                if (!util.isInternetConnected()) {
                    ...
                    declineWorkProposal(work.getApplications().get(0));
                }
                break;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof AssignmentRequestFragment.FragmentSelectApplicationForDetails) {
            listener = (AssignmentRequestFragment.FragmentSelectApplicationForDetails) context;
        } else {
    ...
    public void settingUpHooks() {
        ...
        no_applications = view.findViewById(R.id.no_applications);
        ...
        freelancer_buttons_layout = view.findViewById(R.id.freelancer_buttons_layout);
        freelancer_buttons_layout.setVisibility(View.GONE);
    }
    ...
    public void settingUpWorkData() {
        ...
        if (util.isSameDay(currentTime, ldt)) {
            if (work.getType().equals("proposal")) {
                work_status_by_time.setText("PENDING..\nToday is due Date for this work");
            } else {
                work_status_by_time.setText("OPEN..\nToday is due Date for this work");
            }
            work_status_by_time.setTextColor(ContextCompat.getColor(getContext(),R.color.my_green));
            work_status_by_time_layout.setBackgroundColor(ContextCompat.getColor(getContext(),R.color.my_light_green));
        } else if (currentTime.after(ldt)) {
            if (work.getType().equals("proposal")) {
        ...
        } else if (currentTime.before(ldt)) {
            //work_status_by_time.setText("Open");
            if (work.getType().equals("proposal")) {
                work_status_by_time.setText("PENDING");
            } else {
        ...
        switch (iDashboard.getUserRole()) {
            case "client":
                ...
                if (work.getType().equals("proposal")) {
                    ...
                    if(work.getApplications().get(0).getStatus().equals("declined")){
                        work_status_by_time.setText("CANCELED");
                        work_status_by_time.setTextColor(ContextCompat.getColor(getContext(),R.color.my_purple));
                        work_status_by_time_layout.setBackgroundColor(ContextCompat.getColor(getContext(),R.color.my_light_purple));
                        option_digit.setVisibility(View.GONE);
                    }else{
                        option_digit.setVisibility(View.VISIBLE);
                        option_digit.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                //Display Option menu
                                PopupMenu menu = new PopupMenu(getContext(), option_digit);
                                menu.getMenu().add(1,1 , 1, "Delete");
                    ...
                    if (work.getApplications().size() != 0) {
                        recyclerView.setVisibility(View.VISIBLE);
                        no_applications.setVisibility(View.GONE);
                        initRecyclerView();
                        //todo can't delete or edit , just cancel work.
                        menu.getMenu().add(1,1 , 1, "Cancel");
                    } else {
                        recyclerView.setVisibility(View.GONE);
                        no_applications.setVisibility(View.VISIBLE);
                        //todo can delete and edit work.
                        menu.getMenu().add(1,2 , 2, "Delete");
                       // menu.getMenu().add(1,3,3,"Edit");
                    }
                    ...
                    option_digit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            menu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                                @Override
                                public boolean onMenuItemClick(MenuItem menuItem) {
                                    //todo do this only id there are no applications
                                    switch (menuItem.getItemId()) {
                                        case 1:
            ...
            case "artisan":
                ...
                if (work.getType().equals("proposal")) {
                    ...
                    if(work.getApplications().get(0).getStatus().equals("declined")){
                        ...
                        freelancer_buttons_layout.setVisibility(View.VISIBLE);
                        option_digit.setVisibility(View.GONE);
                    }

                } else {
                    //if post
                    work_type.setText("Your work application details");
                    ...
                    option_digit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            menu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                                @Override
                                public boolean onMenuItemClick(MenuItem menuItem) {
                                    //todo if artisan work application is still request he can delete it , if declined he cannot
                                    //myToast.showInfo("Delete");
                                    //todo delete just the application not the work
                                    deleteUserApplication(work.getApplications());
                                    if (!util.isInternetConnected()) {
                                        //Show a dialog
                                        util.ShowCustomDialog();
                                    }else{
                    ...
                    if(work.getStatus().equals("pending")){
                            option_digit.setVisibility(View.GONE);
                            work_status_by_time.setText("CLOSED APPLICATIONS");
                            cardView_location.setVisibility(View.GONE);
                            work_status_by_time.setTextColor(ContextCompat.getColor(getContext(), R.color.my_purple));
                            work_status_by_time_layout.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.my_light_purple));
                            option_digit.setVisibility(View.GONE);
    ...
    public void deleteUserApplication(ArrayList<Application> applicationList){
        for(int i=0;i<applicationList.size();i++){
            if(applicationList.get(i).getUser().getIdUser().equals(sessionManager.getUser().getIdUser())){
                deleteApplication(applicationList.get(i).getIdApplication());
            }
        }
    }
    ...
    private void initRecyclerView() {
        applicationList = work.getApplications();
    ...
    public void onApplicationClick(int position) {
        initUserApplicationDetails(applicationList.get(position));
    }

    public void initUserApplicationDetails(Application application) {
        listener.onInputSelectUserApplicationForDetailsSent(application);
    ...
    public  void acceptWorkProposal(Application application){
        ...
        assignmentsFragmentViewModel.acceptWorkProposal(application).observe((LifecycleOwner) getActivity(), new Observer<ResponseBody>() {
            ...
            public void onChanged(ResponseBody responseBody) {
                myToast.showSuccess("You accepted to do the work!");
    ...
    public  void declineWorkProposal(Application application){
        ...
        assignmentsFragmentViewModel.declineWorkProposal(application).observe((LifecycleOwner) getActivity(), new Observer<ResponseBody>() {
            @Override
            public void onChanged(ResponseBody responseBody) {
                myToast.showSuccess("You declined this work request!");
                util.dismissAllDialogs(getFragmentManager());
                iDashboard.inflateFragment(getString(R.string.fragment_assignment));
            }
        });
    ...
    public  void deleteWork(int workId){
        ...
        assignmentsFragmentViewModel.deleteWork(workId).observe((LifecycleOwner) getActivity(), new Observer<ResponseBody>() {
            @Override
            public void onChanged(ResponseBody responseBody) {
                myToast.showSuccess("You deleted this work!");
                util.dismissAllDialogs(getFragmentManager());
                iDashboard.inflateFragment(getString(R.string.fragment_assignment));
            }
        });
    ...
    public  void deleteApplication(int applicationId){
        ...
        assignmentsFragmentViewModel.deleteApplication(applicationId).observe((LifecycleOwner) getActivity(), new Observer<ResponseBody>() {
            @Override
            public void onChanged(ResponseBody responseBody) {
                myToast.showSuccess("You deleted this work application!");
                util.dismissAllDialogs(getFragmentManager());
                iDashboard.inflateFragment(getString(R.string.fragment_assignment));
            }
        });
