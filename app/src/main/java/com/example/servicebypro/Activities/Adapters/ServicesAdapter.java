...
public class ServicesAdapter extends RecyclerView.Adapter<ServicesAdapter.ViewHolder> {
    ...
    public ServicesAdapter(ArrayList<Service> listItems, Context mContext, OnServiceListener onServiceListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_item__service, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView, ServicesAdapter.OnServiceListener onServiceListener) {
            super(itemView);
