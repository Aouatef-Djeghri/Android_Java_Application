...
public class UserServicesAdapter extends RecyclerView.Adapter<UserServicesAdapter.ViewHolder> {
    ...
    public UserServicesAdapter(ArrayList<Service> listItems, Context mContext, OnServiceListener onServiceListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_item__user_service, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView, UserServicesAdapter.OnServiceListener onServiceListener) {
            super(itemView);
